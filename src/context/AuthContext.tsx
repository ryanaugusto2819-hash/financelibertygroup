...
interface AuthContextType {
  ...
  countryAccess: "brasil" | "uruguay" | "paraguay" | "caixarel" | null; // null = acesso total
  loading: boolean;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const [countryAccess, setCountryAccess] = useState<"brasil" | "uruguay" | "paraguay" | "caixarel" | null>(null);
