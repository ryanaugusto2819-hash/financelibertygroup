...
const Expenses = ({ country }: ExpensesProps = {}) => {
  ...
  useEffect(() => {
    ...
    if (adsBR > 0) {
      autoExpenses.push({
        date: today, description: `FATURA FACEBOOK ADS 🇧🇷 (${formatCurrency(adsBR)})`,
        category: "Facebook ADS", amount: adsBR, type: "variavel", status: "agendado", isAutoGenerated: true, country: "brasil",
      });
    }
    ...
    if (adsUY > 0) {
      autoExpenses.push({
        date: today, description: `FATURA FACEBOOK ADS 🇺🇾 (${formatCurrency(adsUY)})`,
        category: "Facebook ADS", amount: adsUY, type: "variavel", status: "agendado", isAutoGenerated: true, country: "uruguay",
      });
    }
