        ...
        <FinanceProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/caixarel/recebiveis" element={<ProtectedRoute country="caixarel"><Receivables country="caixarel" /></ProtectedRoute>} />
              ...
              <Route path="/caixarel/despesas" element={<ProtectedRoute country="caixarel"><Expenses country="caixarel" /></ProtectedRoute>} />
